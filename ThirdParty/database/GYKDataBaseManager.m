//
//  GYKDataBaseManager.m
//  数据库访问
//
//  Created by gyk on 15/3/4.
//  Copyright (c) 2015年 GYK. All rights reserved.
//
...
@implementation GYKDataBaseManager
{
...
+ (void)test
{
    GYKDataBaseManager * dbm = [[GYKDataBaseManager alloc] initWithDataBasePath:@"/Users/pansongbiao/Desktop/GP03/day18/DataBase/XX.sqlite"];
    [dbm dropTable:@"男演员"];
